...
python ../scdecorr/multi_domain_train.py \
   -a $arch -cl $cl -optim $optim --workers 2 --batch-size 512 --epochs 1000 \
   --use_dsbn --projector $projector --in_features $in_features --cfg_path $cfg_path --load_checkpoint $load_checkpoint \
